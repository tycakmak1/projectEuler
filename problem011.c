...
int main(){
    int verticalProduct = 1, horizontalProduct = 1, diagonalRightProduct = 1, diagonalLeftProduct = 1, maxProduct = 0
    int grid[][20] = {{8, 02, 22, 97, 38, 15, 00, 40, 00, 75, 04, 05, 07, 78, 52, 12, 50, 77, 91, 8},
    ...
    for(int i = 0; i < 17; i++){
        for(int j = 0; j < 17; j++){
            ...
            if(maxProduct < diagonalRightProduct)
                maxProduct = diagonalRightProduct;
            diagonalLeftProduct = 1;
            diagonalRightProduct = 1;
        }
    }
    printf("%d ", maxProduct);
